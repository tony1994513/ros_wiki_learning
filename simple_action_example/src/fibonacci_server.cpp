...
protected:
  ...
  ros::NodeHandle nh_;
  actionlib::SimpleActionServer<simple_action_example::FibonacciAction> as_; // NodeHandle instance must be created before this line. Otherwise strange error occurs.
